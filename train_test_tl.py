...
from data_loader_filtered_cleaned_windowed import load_data
...
#X, y = load_data(nr_of_subj=nr_of_subj, trial_type=trial_type, chunks=8)
...
#run_transfer_learning(model_name, model, X_train, y_train, X_tl, y_tl, subj_for_training, disabled_layers, multi_branch=True, baseline_train=True)
...
# # test model with transfer learning
# run_transfer_learning(model_name, model, X_train, y_train, X_tl, y_tl, subj_for_training, disabled_layers, baseline_train=True)
